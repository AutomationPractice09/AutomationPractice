...
public class A5_AccessModifier1 {
	...
	protected int acno = 987969;         //this is protected variable (access within class, same package and different package by subclass)
	...
	public static void main(String[] args) 
	{
		...
		System.out.println(obj1.acno);      //able to access protected acno in same class
	}
